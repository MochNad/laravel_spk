function displayAlternatives(alternatives) {
    ...
    table.style.border = "2px solid #79AC78"; // Atur batas untuk seluruh tabel
    ...
    nameHeader.style.border = "2px solid #79AC78"; // Atur batas untuk seluruh sel
    nameHeader.style.color = "#618264"; // Atur warna teks
    ...
    alternatives.forEach(function(alternative) {
        ...
        idCell.style.border = "2px solid #79AC78"; // Atur batas untuk seluruh sel
        idCell.style.color = "#618264"; // Atur warna teks
        ...
        nameCell.style.border = "2px solid #79AC78"; // Atur batas untuk seluruh sel
        nameCell.style.color = "#618264"; // Atur warna teks
    ...
    heading.style.color = "#618264"; // Ganti warna font
...
function displayCriterias(criterias) {
    ...
    headerColumns.forEach(function(columnText) {
        ...
        headerCell.style.border = "2px solid #79AC78"; // Atur batas untuk seluruh sel
        headerCell.style.color = "#618264"; // Atur warna teks
    ...
    criterias.forEach(function(criteria) {
        ...
        criteriaCell.style.border = "2px solid #79AC78"; // Atur batas untuk seluruh sel
        criteriaCell.style.color = "#618264"; // Atur warna teks
        var weightCell = document.createElement("td");
        weightCell.textContent = criteria.weight;
        weightCell.style.border = "2px solid #79AC78"; // Atur batas untuk seluruh sel
        weightCell.style.color = "#618264"; // Atur warna teks
...
function displayResultN(n) {
    ...
    element.innerHTML += '<h4 class="text-center m-0" style="color: #618264;">' + n + ' Kriteria</h3>';
}

function displayResultM(m) {
    var element = document.getElementById("m");
    element.innerHTML += '<h4 class="text-center m-0" style="color: #618264;">' + m + ' Alternatif</h3>';
}
...
function displayResultX(x) {
    ...
    heading.style.color = "#618264"; // Change font color
    ...
    altCell.style.color = "#618264";
    altCell.style.border = "2px solid #79AC78"; // Add border to Alternatif cell
    ...
    categoryCell.style.color = "#618264"; // Change font color
    categoryCell.style.border = "2px solid #79AC78"; // Change border color
    ...
    for (var criterion in x[1]) {
        ...
        headerCell.style.color = "#618264"; // Change font color
        headerCell.style.border = "2px solid #79AC78"; // Change border color
        headerRow.appendChild(headerCell);
    }
    ...
    for (var alternative in x) {
        ...
        altCell.classList.add("text-center");
        altCell.style.color = "#618264"; // Change font color
        altCell.style.border = "2px solid #79AC78"; // Add border to Alternatif cell
        ...
        for (var value in x[alternative]) {
            ...
            cell.style.color = "#618264"; // Change font color
            cell.style.border = "2px solid #79AC78"; // Change border color
...
function displayResultX_Rata(x_rata) {
    ...
    table.style.color = "#618264"; // Set the font color
    ...
    rows.forEach(function(row) {
        row.style.border = "2px solid #79AC78"; // Add borders to rows

        var cells = row.querySelectorAll("td, th");
        cells.forEach(function(cell) {
            cell.style.border = "2px solid #79AC78"; // Add borders to cells
        });
    });
...
function displayResultCriteria(criteria) {
    ...
    title.style.color = "#618264"; // Change font color
    title.classList.add("text-center", "mb-3"); // Add custom CSS classes

    // Create a table element
    var table = document.createElement("table");
    table.className = "table table-bordered";
    table.style.border = "2px solid #79AC78"; // Add border to the table
    table.style.color = "#618264"; // Change font color
    ...
    criteriaHeaderCell.style.border = "2px solid #79AC78"; // Add border to the cell
    ...
    for (var criterion in criteria) {
        ...
        headerCell.style.border = "2px solid #79AC78"; // Add border to the cell
        headerRow.appendChild(headerCell);
    }
    ...
    weightCell.style.border = "2px solid #79AC78"; // Add border to the cell
    ...
    for (var criterion in criteria) {
        ...
        cell.style.border = "2px solid #79AC78"; // Add border to the cell
...
function displayResultC(c) {
    ...
    table.style.border = "2px solid #79AC78"; // Atur batas untuk seluruh tabel
    table.style.color = "#618264"; // Atur warna teks untuk seluruh tabel
    ...
    criteriaHeaderCell.style.border = "2px solid #79AC78"; // Atur batas untuk seluruh sel
    criteriaHeaderCell.style.color = "#618264"; // Atur warna teks untuk seluruh sel
    headerRow.appendChild(criteriaHeaderCell);
    ...
    for (var criterion in c[1]) {
        ...
        headerCell.textContent = "C" + criterion;
        headerCell.style.border = "2px solid #79AC78"; // Atur batas untuk seluruh sel
        headerCell.style.color = "#618264"; // Atur warna teks untuk seluruh sel
        headerRow.appendChild(headerCell);
    }
    ...
    for (var criterion in c) {
        ...
        criterionCell.style.border = "2px solid #79AC78"; // Atur batas untuk seluruh sel
        criterionCell.style.color = "#618264"; // Atur warna teks untuk seluruh sel
        row.appendChild(criterionCell);

        // Iterate through the comparison values for this criterion
        for (var value in c[criterion]) {
            var cell = document.createElement("td");
            cell.style.border = "2px solid #79AC78"; // Atur batas untuk seluruh sel
            cell.style.color = "#618264"; // Atur warna teks untuk seluruh sel
...
function displayResultThreshold_C(threshold_c) {
    ...
    element.innerHTML += '<h4 class="text-center m-0" style="color: #618264;">' + threshold_c + ' Threshold c</h3>';
}
...
function displayResultThreshold_D(threshold_d) {
    ...
    element.innerHTML += '<h4 class="text-center m-0" style="color: #618264;">' + threshold_d + ' Threshold d</h3>';
}
...
function displayResultConclusion(conclusionMatrix) {
    ...
    headingDapat.style.color = "#618264"; // Ganti warna font
    ...
    headingTidak.style.color = "#618264"; // Ganti warna font
    ...
    for (var row in conclusionMatrix) {
        for (var col in conclusionMatrix[row]) {
            if (conclusionMatrix[row][col] === 1) {
                ...
                listItem.style.color = "#618264"; // Atur warna teks
